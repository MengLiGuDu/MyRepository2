...
(function ($) {
    ...
    BootstrapTable.prototype.initPagination = function () {
        ...
        if (!this.options.onlyInfoPagination) {
            ...
            html.push('</div>',
				'<span class="goPage"><input type="button" value="跳转" class="pageBtn btn btn-info" onclick="toPage();"></span>',
				'<span class="goPage">页</span>',
				'<span class="goPage"><input id="pageNum" class="pageNum form-control" style="width: 40px;" type="text"></span>',
				'<span class="goPage">跳转到第</span>',
