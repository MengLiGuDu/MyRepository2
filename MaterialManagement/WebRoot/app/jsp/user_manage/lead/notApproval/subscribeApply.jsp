    ...
    $('#test-table').bootstrapTable({
       ...
       showExport: true,                    
        ...
        columns: [
        {
            ...
            align: 'center',
            formatter:function(value,row,index){  
            	 var e = '<a href="#" class="btn btn-default" onclick="know()">明细</a> ';
                 var d = '<a href="#" class="btn btn-default" onclick="read()">批准</a> ';
                 var f = '<a href="#" class="btn btn-default" onclick="no()">不批准</a> ';
