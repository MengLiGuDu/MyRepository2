...
$(function(){
    $('#test-table').bootstrapTable({
        ...
        url: "<%=PN%>/notExamineReceiveList.action",
        queryParamsType:'', 
        toolbar: '#toolbar',    
        striped: true,      
        cache: false,     
       ...
       showExport: true,                    
        ...
        columns: [
        {
            ...
            formatter:function(value,row,index){  
                 ...
                 var d = '<a href="#" class="btn btn-default" mce_href="#" onclick="read(\''+ row.id + '\')">批准</a> ';
                 var f = '<a href="#" class="btn btn-default" mce_href="#" onclick="no(\''+ row.id + '\')">不批准</a> ';
                 var g = '<a href="#" class="btn btn-default" mce_href="#" onclick="edit(\''+ row.id + '\')">审批跟踪</a> ';
                      return e+d+f+g;
            } 
         }
        ],
