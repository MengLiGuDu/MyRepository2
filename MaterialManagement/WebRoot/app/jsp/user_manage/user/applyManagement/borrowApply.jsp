	...
	<div class="container-fluid"><!-- -fluid -->
		  <div class="row">
		    <div style="float: left">
		      <button class="btn btn-success btn-lg" data-toggle="modal" data-target="#myModal" id="add">添加借用</button>
		    </div>
           ...
           showExport: true,                    
            ...
            columns: [
            {
                ...
                formatter:function(value,row,index){
                    ...
                    var d="";
                    if(row.apply_state != '0'){
                		d = '<button class="btn btn-default" onclick="approveTrace(\''+ row.apply_id +'\')">审批追踪</button>';
                	}
                    
                    var g = "";
                    	if(row.submit_state != '0'){
                    		g = '<button class="btn btn-default" onclick="withdraw(\''+ row.apply_id +'\')">撤回</button> ';
                    	}
