...
<div style="width:1500px; height:400px;margin-left:80px;">
	<table id="test-table" class="col-xs-5" data-toolbar="#toolbar" ></table>
</div>
</body>
...
function initTable(){
    $('#test-table').bootstrapTable({
        ...
        columns: [{
            ...
            width:300,
            formatter:function(value,row,index){  
              var e = '<a href="/" class="btn btn-default" mce_href="#"  data-toggle="modal" data-target="#mymode2">明细</a> ';
              var d = '<a href="/" class="btn btn-default" mce_href="#"  data-toggle="modal" data-target="#mymode2">批量跟踪</a> ';
              var f = '<a href="/" class="btn btn-default" mce_href="#"  data-toggle="modal" data-target="#mymode2">变更数据</a> ';
              return e+d+f;
            }
          }],
        pagination:true 
