...
$(function(){
	function AddFunctionAlty(value,row,index){
		  return[
		       ...
		       '<button id="TableDelete" type="button" class="btn btn-default">切换审核状态</button>'
		 ]
	}
	 window.operateEvents = {
		"click #TableEditor":function(e,value,row,index){
	     ...
	     "click #TableDelete":function(e,value,row,index){
			...
			$.ajax({
				url :  "${path}/ClientRelation/updateStatus.action",
				type : "post",
				data :{
					'order_id':id,
					'status':status
	...
	$("#tb").bootstrapTable({
		...
		columns : [  [ 
			...
			{field : 'product_id',align : 'center',title : '产品编号',
		    	  	formatter:function(value,row,index){
			...
			{field : 'client_id',align : 'center',title : '客户编号',
				 formatter:function(value,row,index){
